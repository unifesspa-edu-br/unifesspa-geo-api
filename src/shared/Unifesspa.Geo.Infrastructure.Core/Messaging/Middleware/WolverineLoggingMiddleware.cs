namespace Unifesspa.Geo.Infrastructure.Core.Messaging.Middleware;
...
/// fica <c>Unifesspa.Geo.Infrastructure.Core.Messaging.Middleware.WolverineLoggingMiddlewareLogger</c>.
/// </summary>
